...
En la tabla ~\ref{distribucion} se observa el resultado de la distribucion de los datos de cada grupo utilizando los metodos mencionados. $Error$ representa el promedio del error absoluto en cada grupo, $Tamaño$ representa el promedio de la carga de almacenamiento que ocupan los grupos y $Similitud$ es la similitud entre los documentos de las muestras de un mismo grupo.
...
\hline
Grupos & Error  & Tamaño(KiB)  & Similitud \\
\hline
Método 1 &  0.2  & 6553.6 &  - \\
\hline

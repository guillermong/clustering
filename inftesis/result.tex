...
En el grafico \ref{fig:grafico2:a} muestra el promedio, el minimo  y el maximo tamaño entre las 10 pruebas para cada caso realizado con el algoritmo sin las mejoras implementadas. Del grafico se observa que aumentando las muestras hasta llegar a las 30 muestras la compresión de los datos bajan y luego se mantienen estable, en cambio en el grafico \ref{fig:grafico2:b} la compresión sigue mejorando luego de las 30 muestras y el rango entre el maximo y el minimo cada vez es menor, lo que significa que las muestras tomadas aleatoriamente influyen menos en la compresión.

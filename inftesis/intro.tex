...
\sloppy{Punto: se define como un vector de $n$ dimensiones, $P= \{ v_{1}, v_{2},...., v_{n} \}$. Un punto $P \in R^{n}$ se dice que es un punto de cluster para un subconjunto $A$ si para cada $\delta > 0 $, $\delta$ vecindad de $P$, tenemos $B(P;\delta)\cap A \not= \emptyset $, 

...
\begin{enumerate}
  ...
  \item Se evalúan los resultados obtenidos, sobre la base de estos se evalúa cómo mejorar el algoritmo implementado y se vuelve a repetir el proceso desde el segundo paso, para ir mejorando los resultados.
\end{enumerate}
